...
#define STRING_CONFIG_H_AUTHOR "(Bill&Troy,Jan 2024 Final)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TroyRampGrapBLT"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // MatterHacker + Borosilic Glass
    #define  DEFAULT_bedKp 193.37
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 3.1   //-1.81   // Z offset: -below +above  [the nozzle] ***WILL NEED TO CHANGE FOR YOUR PRINTER***
...
#define X_MIN_POS 0
#define Y_MIN_POS -5
#define Z_MIN_POS -10   //-10
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
//z max from matterhackers website
#define Z_MAX_POS 188.2
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT  ((X_BED_SIZE) -25)   // ((X_BED_SIZE) / 2)  X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT  ((Y_BED_SIZE) -25)   // ((Y_BED_SIZE) / 2)   Y point for Z homing when homing all axes (G28).
#endif
...
// Preheat Constants
#define PREHEAT_1_TEMP_HOTEND 255   // NYLON
#define PREHEAT_1_TEMP_BED     55   //
#define PREHEAT_1_FAN_SPEED     0   // Value from 0 to 255

#define PREHEAT_2_TEMP_HOTEND 240   //PETG
